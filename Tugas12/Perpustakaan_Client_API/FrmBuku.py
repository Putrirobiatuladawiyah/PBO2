...
class FrmBuku:
    ...
    def aturKomponen(self):
        ...
        self.tree.column('kodebuku', width="40")
        self.tree.heading('judul', text='JUDUL')
        self.tree.column('judul', width="50")
        self.tree.heading('pengarang', text='PENGARANG')
        self.tree.column('pengarang', width="60")
        self.tree.heading('penerbit', text='PENERBIT')
        self.tree.column('penerbit', width="70")
        self.tree.heading('tahun', text='TAHUN')
        self.tree.column('tahun', width="80")
